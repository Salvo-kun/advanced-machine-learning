...
import toDayGan.util.util as util
from toDayGan.util.image_pool import ImagePool
...
class ComboGANModel(BaseModel):
    ...
    def get_generated_tensors(self, domain):
        return self.visuals[domain::self.n_domains]
