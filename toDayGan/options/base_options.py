import argparse
import os
from toDayGan.util import util
import torch
...
class BaseOptions():
    ...
    def parse(self, arguments=None, verbose=True):
        if not self.initialized:
            self.initialize()
        self.opt = self.parser.parse_args(args=arguments) if arguments else self.parser.parse_args()
